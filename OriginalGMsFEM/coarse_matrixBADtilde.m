function [A0,dir,dirn,vC,P1]=coarse_matrixBADtilde(dom,dom_ov,Nx,Ny)
dirn=[];
vC=[];
P1=[];
dir=[];
        ...
        for l=1:NbadI
            ...
            if i1==1 || i1==Nx+1|| i2==1|| i2==(Ny+1)
                if l==1
                    ...
                    Ig=dom_ov(i1,i2).Ig;
                    psi1=dom_ov(i1,i2).psibadtilde(:,1);
                    P1=[P1;psi1(Ig(1))];
                end
                dir=[dir,I];
            end
            ...
            for j1=1:Nx+1
                for j2=1:Ny+1
                    NbadJ=dom_ov(j1,j2).Nbadtilde;
                    for m=1:NbadJ

                        phi2=dom_ov(j1,j2).cbtilde(m).phi;
                        J=J+1;
